...
export function FuturisticBotIcon(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <g>
        {/* Shadow */}
        <path d="M18 8H6C4.89543 8 4 8.89543 4 10V18C4 19.1046 4.89543 20 6 20H18C19.1046 20 20 19.1046 20 18V10C20 8.89543 19.1046 8 18 8Z" fill="black" opacity="0.2" transform="translate(0, 1)"/>
