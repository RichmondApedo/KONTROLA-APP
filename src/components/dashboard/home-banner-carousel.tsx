      ...
      <CarouselContent>
        {activeBanners.map((banner, index) => (
          <CarouselItem key={banner.id}>
            <div className="relative h-[160px] min-[380px]:h-[200px] xs:h-[260px] md:h-[320px] lg:h-[380px] w-full overflow-hidden rounded-2xl shadow-lg border border-border/50">
              <Image
                src={banner.imageUrl}
