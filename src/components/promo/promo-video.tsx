...
const SCENES = [
  ...
  },
  {
    ...
    description: 'Know exactly when to refuel with our proprietary prediction engine.',
          ...
          {SCENES.map((scene, index) => (
            <div key={scene.id} className="embla__slide flex-[0_0_100%] h-full relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center p-8 md:p-24 overflow-hidden">
                <div className={cn(
                  "relative w-full max-w-5xl aspect-video transition-all [transition-duration:3000ms] ease-cinematic",
