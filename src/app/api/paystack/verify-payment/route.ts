...
export async function POST(req: Request) {
    ...
    try {
        ...
        // 1. Verify the new transaction with Paystack
        ...
        // 2. Disable any existing subscription for the user
        ...
        if (profileSnap.exists()) {
            ...
            if (paystackCustomerCode) {
                ...
                if (subResponse.ok) {
                    ...
                    console.warn(`Could not fetch existing subscriptions for customer ${paystackCustomerCode}. Proceeding with new subscription.`);
                }
            }
        }
