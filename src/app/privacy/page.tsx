          ...
          <CardContent className="prose prose-sm sm:prose-base dark:prose-invert max-w-none space-y-6">
              ...
              <div className="space-y-2 pl-4">
                ...
                <ul>
                  ...
                  <li>
                   ...
                   <li>
                    <strong>Vehicle & Fuel Data:</strong> When using the Fuel Tracking feature, we collect odometer readings, fuel volume (liters), price per unit, refuel station names, and vehicle/asset identifiers.
                  </li>
                </ul>
            ...
            <section>
              <h2 className="font-semibold text-xl">3. AI Financial Guidance Disclaimer</h2>
                <p>
                Kontrola may use artificial intelligence (AI), including Google Genkit and the Gemini Large Language Model, to provide automated
            ...
            <section>
              ...
              <ul>
                <li>
                  ...
                  Google), data analytics, AI processing (Google Cloud), and payment processing (Paystack). These
