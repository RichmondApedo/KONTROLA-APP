          ...
          <CardContent className="prose prose-sm sm:prose-base dark:prose-invert max-w-none space-y-6">
            ...
            <section>
              ...
              <div className="space-y-2 pl-4">
                ...
                <ul>
                  <li>
                    <strong>Identity & Contact Data:</strong> Your full name, email
                    address, and phone number.
                  </li>
                  <li>
                    <strong>Profile Data:</strong> Your preferred language, currency,
                    and other settings.
                  </li>
                </ul>
                ...
                <h3 className="font-semibold">c. Information We Collect Automatically (Usage Data)</h3>
                <p>
                  As you interact with our App, we may automatically collect
                  technical data about your device and usage patterns. This
                  includes:
                </p>
                <ul>
                  <li>
                  ...
                  <li>
                    ...
                    such as features used, pages viewed, and the time,
            ...
            <section>
              <h2 className="font-semibold text-xl">3. AI Financial Guidance Disclaimer</h2>
                ...
                financial insights, suggestions, and recommendations based on the
